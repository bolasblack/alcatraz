...
├── decision/
│   └── final-recommendation.md       ← Architecture decision record
└── research/
...
| File | Description |
|------|-------------|
| [decision/final-recommendation.md](decision/final-recommendation.md) | Final architecture recommendation with platform-specific solutions |
